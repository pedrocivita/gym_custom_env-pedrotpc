...
STAGES = {
    5:  dict(obstacles=3,  max_steps=200, total_timesteps=500_000,   fps_total=1200),
    10: dict(obstacles=12, max_steps=600, total_timesteps=2_000_000, fps_total=700),
    20: dict(obstacles=48, max_steps=2000, total_timesteps=3_000_000, fps_total=300),
}
