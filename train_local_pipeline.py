...
STAGES = {
    5:  dict(obstacles=3,  max_steps=200, total_timesteps=300_000,   fps_total=600),
    10: dict(obstacles=12, max_steps=600, total_timesteps=1_200_000, fps_total=135),
    20: dict(obstacles=48, max_steps=2000, total_timesteps=1_800_000, fps_total=80),
}
